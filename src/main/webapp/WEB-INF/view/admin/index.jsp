							...
							<div class="card">
								<div class="card-body">
									<div
										...
										<div class="text-right text-md-center text-lg-left ml-lg-4">
											<h1 class="font-weight-bold mb-0">${detectionCount}</h1>
											<p class="mb-0">Detections</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									<div
										...
										<div class="text-right text-md-center text-lg-left ml-lg-4">
											<h1 class="font-weight-bold mb-0">${companyCount}</h1>
							...
							<div class="row">
								<div class="col-lg-6">
									<img class="rounded mw-100"
										src="<%=request.getContextPath()%>/adminResources/images/homeimage.jpg">

								</div>
								<div class="col-lg-6">
									<h2 class="text-center">Visual Inspection of Workplace Productivity</h2>
									<p class="text-justify text-muted">The Visual Inspection of
										Workplace Productivity software presented in this report is a
										face detection and time recording toll. The software utilizes
										advanced computer vision techniques to detect faces from video
										streams in real-time and records the time of detection. The
										software has a wide range of applications.</p>
									<p class="text-justify text-muted">The software employs an
										advanced algorithm that can accurately detect faces in
										different lightning conditions, angles and backgrounds. It
										uses a deep learning model that has been trained on a vast
										dataset of faces, allowing it to recognize faces with high
										accuracy and speed.</p>
									<p class="text-justify text-muted">The software is easy to
										use and can be installed on different devices including
										cameras and computers. The user can set up the software to
										capture video streams at specified intervals and record time
										of face detection. The software can also be integrated with
										other systems, such as attendance tracking software to
										automate the process of time recording.</p>
									<p class="text-justify text-muted">Overall, the software is
										a reliable and efficient tool for detecting faces and
										recording the time of detection. Its accuracy, speed, and ease
										to use make it a valuable tool for various applications,
										including attendance tracking, security and marketing
										research.</p>
								</div>
							</div>
						</div>
