...
<body>
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-header custom-card-header">
									<h4 class="text-white m-0">Manage Employee</h4>
								</div>
								<div class="card-body">
									<f:form class="cmxform" id="signupForm" method="post"
										...
										<fieldset>
											<div class="form-group">
												...
												<f:input path="employeename" id="employeename"
													class="form-control" name="employeename" required="required"/>
											</div>
											<div class="row">
												<div class="form-group col-4">
													<label for="employeeid">Employee Id</label>
													<f:input path="employeeid" id="employeeid"
														class="form-control" name="employeeid" />
												</div>
												<div class="form-group col-4">
													<label for="employeecontact">Contact</label>
													<f:input path="employeecontact" id="employeecontact"
														class="form-control" name="employeecontact" />
												</div>
												<div class="form-group col-4">
													<label for="employeemail">Email</label>
													<f:input path="employeemail" id="employeemail"
														class="form-control" name="employeemail" type="email" />
												</div>
											</div>
											<div class="row">
												<div class="form-group col-6">
													<label for="doj">Date of Joining</label>
													<f:input path="doj" id="doj"
														class="form-control" name="doj" type="date" />
												</div>
												<div class="form-group col-6">
	...
	<script
		src="<%=request.getContextPath()%>/adminResources/js/validation/manageEmployee.js"></script>
	<!-- endinject -->
	<!-- inject:js -->
	<script
