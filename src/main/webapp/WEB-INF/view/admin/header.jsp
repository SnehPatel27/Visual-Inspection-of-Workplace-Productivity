...
<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
	<div
		...
		<a class="navbar-brand brand-logo" href="index"><img
			src="<%=request.getContextPath()%>/adminResources/images/projectlogo.jpg" alt="logo" /></a> <%-- <a
	...
	<div class="navbar-menu-wrapper d-flex align-items-center justify-content-end justify-content-lg-start">
		...
		<ul class="navbar-nav navbar-nav-right">
				...
				id="profileDropdown"> <img src="<%=request.getContextPath()%>/adminResources/images/img_avatar.jpg"
