											...
											<tbody>
												<c:forEach items="${Complainlist}" var="i" varStatus="j">
													<tr>
														...
														<td><a href="<%=request.getContextPath()%>/complaint-docs/${i.fileName}" target="_blank"><span class="mdi mdi-attachment"
															style="font-size: 20px;"></span></a></td>
														<td>${i.complaindate}</td>
														<td>${i.complainreplydate}</td>
														
														<td class="text-tomcat" title="${i.complainreply}">
															<span class="tooltiptext">${i.complainreply }</span>
														</td>
														<td>${i.status}</td>
														<td><a
